...
export default function Auth() {
  ...
  // Decide o destino olhando o usuario.tipo que volta do backend.
  ...
  // CADASTRO — POST /auth/cadastro { nome, email, senha }
      ...
      <div className="app">
        <div className="panel-visual">
          ...
          <div className="visual-copy">
            <h1>Organize sua rotina de estudos <span className="accent-word">matéria por matéria.</span></h1>
              ...
              <div className="view" ref={loginViewRef}>
                ...
                <form onSubmit={handleLoginSubmit} noValidate>
                  ...
                  <div className="field-row">
                    <a href="#" className="link-inline">Esqueceu a senha?</a>
                  </div>
